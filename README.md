<link rel="stylesheet" type="text/css" href="style_content_locker.css"><script type="text/javascript" src="jquery_content_locker.js"></script><!DOCTYPE html>
...
<div class="col-xs-1 responsive-button-wrapper no-padding-left">
<div class="value-button-wrapper">
<div id="increase-resource-2" class="increase-button value-button">+</div>
</div>
</div>
</div>
</div>
...
<img class="console-resource-img" src="img/resource-2-img.png" />
...
<p>This privacy policy ("Policy") describes how we collect, protect and use the personally identifiable information ("Personal Information") you ("User", "you" or "your") provide on the https://www.mywebsite..online website and any of its products or services (collectively, "Website" or "Services"). It also describes the choices available to you regarding our use of your personal information and how you can access and update this information. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.</p>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-101959665-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-101959665-1');
</script>
</body>
</html>
